...
const canManage = hasPermission("INVENTORY_ADJUST");
...
useState<Map<string, Product>>(new Map());
...
if (error || !receipt) {
return ( <AppShell> <div className="p-6 lg:p-8"> <div className="rounded-xl border border-danger/30 bg-danger-soft px-6 py-10"> <div className="flex items-start gap-3"> <div className="text-danger"> <AlertIcon /> </div>
